...
class Rule:
    ...
    def __init__(self, dict_rules, k):
        ...
        self.actives = [self.variables[index] for index in sorted(indexes)]  # list of variables directly involved
        self.A, self.b = self.__get_matrices__()  # conditions converted to matrix system
